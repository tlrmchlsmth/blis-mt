...
#include "blis.h"
 ...
 void bli_sgemm_4x6(
                    ...
                    float* a_next, float* b_next, dim_t thread_id
                  )
{
 ...
 void bli_dgemm_4x6(
                    ...
                    double* a_next, double* b_next, dim_t thread_id
                  )
{
    dim_t   k_iter;
	dim_t   k_left;
 ...
 void bli_cgemm_4x6(
                    ...
                    scomplex* a_next, scomplex* b_next, dim_t thread_id
                  )
{
	bli_check_error_code( BLIS_NOT_YET_IMPLEMENTED );
}
 ...
 void bli_zgemm_4x6(
                    ...
                    dcomplex* a_next, dcomplex* b_next, dim_t thread_id
                  )
{
	bli_check_error_code( BLIS_NOT_YET_IMPLEMENTED );
}
